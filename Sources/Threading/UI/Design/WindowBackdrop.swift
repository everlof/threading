...
public enum WindowBackdrop {
    ...
    public static var ink: Design.Ink { Design.Text.on(color) }
    ...
    public static func opaque(_ role: NSColor) -> NSColor {
    ...
    /// toolbar for nothing.
    public static func set(_ newGround: Ground) {
...
public struct WindowBackdropDidChange: AppEvent {
    public static let name = Notification.Name("windowBackdropDidChange")
