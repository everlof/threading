    ...
    private func refresh() {
        ...
        case .disabled:
            ...
            updatePairing(
                ...
                detail: L10n.string(
                    "Turn on Remote Access. Threading will start a local mirror and connect "
        ...
        case .listening(let port):
            ...
            case .connected(let origin):
                ...
                updatePairing(
                    ...
                    detail: L10n.string(
                        "Open Threading on iPhone, choose Pair a Mac, then scan this code."
                    ),
                    action: L10n.string("Copy Pairing Link"),
                    actionEnabled: true,
                    prominent: false,
                    pairingPayload: coordinator.pairingCodePayload
                )
        ...
        pairingInstruction.stringValue = code == nil
            ...
            : L10n.string(
                "Only scan this owner code on a device you control. It can access every chat "
                    + "on this Mac. The beta relay and pairing are renewed when Threading restarts."
            )
    }
