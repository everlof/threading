...
final class AgentToolCoordinator: MCPToolHandling {
    ...
    private func extensionProposeInstall(
        ...
        Task { @MainActor [weak self] in
            ...
            case .success(let bundle):
                ...
                let isInstalled = ExtensionManager.shared.installedExtensions
    ...
    private func proposeUpdate(
        ...
        ExtensionManager.shared.updatePlan(from: packageURL) { [weak self] result in
            guard let self else {
            ...
            case .success(let plan):
                ...
                ConfirmationAlert.ask(request, in: self.windowProvider()) { approved in
                    ...
                    ExtensionManager.shared.update(
                        from: packageURL,
                        approving: plan
                    ) { result in
                        switch result {
