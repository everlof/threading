...
enum PTYHostDefaults {
    ...
    // Compatibility names for app call sites; the portable client owns these bounds.
    static let connectTimeout = PTYHostClientDefaults.connectTimeout
    static let helloTimeout = PTYHostClientDefaults.helloTimeout
    static let maximumQueuedWriteBytes = PTYHostClientDefaults.maximumQueuedWriteBytes
    static let handshakeReadChunkBytes = PTYHostClientDefaults.handshakeReadChunkBytes
    static let clientQueueLabel = PTYHostClientDefaults.clientQueueLabel
    static let clientQueueQoS = PTYHostClientDefaults.clientQueueQoS
