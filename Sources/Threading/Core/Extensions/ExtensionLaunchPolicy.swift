...
struct ExtensionLaunchRequest {
    ...
    /// The entry mode, e.g. `["--threading-register"]`. A policy may reject an unknown mode.
...
protocol ExtensionChildProcess: AnyObject, Sendable {
...
protocol ExtensionLaunchPolicy: Sendable {
...
enum ExtensionLaunchEnvironment {
    ...
    static let base: [String: String] = [
        ...
        "LANG": "en_US.UTF-8",
        "THREADING_EXTENSION_PROTOCOL": "1"
    ]
...
struct SandboxExecLaunchPolicy: ExtensionLaunchPolicy, @unchecked Sendable {
