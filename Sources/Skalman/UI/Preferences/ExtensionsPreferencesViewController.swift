...
final class ExtensionsPreferencesViewController: NSViewController {
    ...
    private func render() {
        ...
        var sections: [NSView] = [
            ...
            SettingsUI.note(
                "Extensions are copied into Skalman before they can run. Importing leaves one "
            ...
            SettingsUI.section(
                ...
                SettingsCard(rows: [
                    SettingsUI.row(
                        ...
                        subtitle: "Choose a .skalmanextension package or an unpacked development directory.",
