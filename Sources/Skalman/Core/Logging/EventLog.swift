...
///
/// `SkalmanLogger` is the live view — `log stream` while a bug reproduces. It is the wrong
...
/// crash of 22 July 2026: `log show --predicate 'subsystem == "com.skalman"'` returned not a
...
enum EventLogDefaults {
    /// Under Application Support ▸ Skalman, alongside the stores it explains.
    static let directoryName = "Logs"

    static let filePrefix = "skalman-"
    static let fileExtension = "jsonl"
    static let dayFormat = "yyyy-MM-dd"

    static let markerFileName = "launch.json"
    static let queueLabel = "com.skalman.eventlog"
    ...
    static let crashReportPrefix = "Skalman-"
