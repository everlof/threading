...
struct RemoteRouter {
    ...
    func staticResponse(forPath path: String) -> HTTPResponse? {
        ...
        guard let url = bundle.url(
            ...
            SkalmanLogger.remote.error("Remote client asset missing from the bundle: \(asset.file, privacy: .public)")
    ...
    static let deviceHeader = "x-skalman-device"
    ...
    static let protocolHeader = "x-skalman-protocol"
    static let protocolMinimumHeader = "x-skalman-protocol-min"
