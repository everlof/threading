...
/// Assembles a `.skalmanextension` from a manifest and a built executable.
///
...
/// extensions are written from inside Skalman (`AUTHORING_FLOW.md`): the loop there is edit →
