...
struct RemoteGitReviewView: View {
    ...
    @State private var section = Section.changed
    ...
    private func loadRepositoryFiles() async {
        ...
        if isReviewDemo {
            repositoryFiles = RemoteRepositoryFilesDTO(paths: [
                "AGENTS.md",
                "README.md",
                "SkalmanRemoteKit/Sources/SkalmanRemoteKit/RemoteWireDTO.swift",
                "Sources/SkalmanMobile/RemoteGitReviewView.swift",
                "Sources/SkalmanMobile/SessionDetailView.swift",
            ])
    ...
    private var isReviewDemo: Bool {
        ProcessInfo.processInfo.environment["SKALMAN_MOBILE_DEMO"] == "review"
    }
    ...
    private static func demoSnapshot(
        ...
        let first = RemoteGitFileDiffDTO(
            path: "Sources/SkalmanMobile/RemoteGitReviewView.swift",
            change: "modified",
            hunks: [
                RemoteGitHunkDTO(
        ...
        let second = RemoteGitFileDiffDTO(
            path: "SkalmanRemoteKit/Sources/SkalmanRemoteKit/RemoteWireDTO.swift",
            change: "modified",
            hunks: [
                RemoteGitHunkDTO(
                    header: "@@ -560,2 +560,5 @@",
