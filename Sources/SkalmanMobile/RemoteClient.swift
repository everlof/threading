...
struct RemoteClient {
    ...
    private func request(url: URL) -> URLRequest {
        ...
        request.setValue(String(RemoteProtocol.current), forHTTPHeaderField: "X-Skalman-Protocol")
        request.setValue(
            String(RemoteProtocol.minimumSupported),
            forHTTPHeaderField: "X-Skalman-Protocol-Min"
        )
        request.setValue("Skalman-iOS", forHTTPHeaderField: "X-Skalman-Client")
        request.setValue(RemoteDeviceIdentity.current, forHTTPHeaderField: "X-Skalman-Device")
