...
final class RemoteSessionConnection: ObservableObject {
    ...
    static func demoConversation() -> RemoteSessionConnection {
        ...
        connection.theme = ProcessInfo.processInfo.environment["SKALMAN_MOBILE_THEME"] == "light"
        ...
        let coreRows: [RemoteConversationRowDTO] = [
                ...
                .init(
                    ...
                    kind: "tool",
                    toolName: "Bash",
                    summary: "xcodebuild SkalmanMobile",
        ...
        let isStressFixture = ProcessInfo.processInfo.environment["SKALMAN_MOBILE_DEMO"]
            == "conversation-stress"
        ...
        if isStressFixture {
            ...
            rows = history + [
                ...
                .init(
                    ...
                    kind: "tool",
                    toolName: "Bash",
                    summary: "xcodebuild -scheme SkalmanMobile test",
    ...
    static func demoPermissionConversation() -> RemoteSessionConnection {
        ...
        connection.conversationStore.replace(with: RemoteConversationSnapshotDTO(
            ...
            permission: .init(
                ...
                toolName: "Edit",
                summary: "Sources/SkalmanMobile/RemoteSessionConnection.swift",
