...
///
/// Threading commits `targetVersion` only after the extension has registered successfully. An
...
public enum ExtensionDataMigrationEnvironment {
    public static let previousVersion = "THREADING_EXTENSION_DATA_VERSION_FROM"
    public static let targetVersion = "THREADING_EXTENSION_DATA_VERSION_TO"
}
