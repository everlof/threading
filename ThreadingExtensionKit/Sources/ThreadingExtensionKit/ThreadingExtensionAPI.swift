...
/// The supported safe-extension contract shipped by ThreadingExtensionKit SDK snapshot 1.
///
...
/// version domain.
public enum ThreadingExtensionAPI {
    ...
    public static let companionProtocolVersion = ThreadingCompanionAPI.protocolVersion
    ...
    public static let componentContractVersions: [ExtensionComponentID: Int] =
        Dictionary(uniqueKeysWithValues: ThreadingComponentCatalog.all.map {
            ($0.id, $0.version)
        })
}
