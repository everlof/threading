...
/// Validation limits for secrets brokered through Threading.
///
/// Secret values never enter extension storage or the process environment. The extension sends
/// them only over its generation-bound loopback connection and Threading persists them in Keychain.
