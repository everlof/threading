...
![Threading particle mark in weave, breathe, and orbit treatments](threading-particle-mark.png)
...
package keeps its own state showcase in `ThinkingOrbs/docs/orbs.png`; Threading's shield,
