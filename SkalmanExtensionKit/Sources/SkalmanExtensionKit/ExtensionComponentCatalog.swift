...
/// Skalman's current public component catalogue.
///
...
public enum SkalmanComponentCatalog {
    ...
    public static func patchSchema(
        ...
        let slotSchemas = contract.slots.map { slot -> ExtensionJSONValue in
            var children: [String: ExtensionJSONValue] = [
                ...
                "items": .object([
                    "$ref": .string(
                        "https://skalman.invalid/schema/extension-node.schema.json"
                    )
                ])
            ]
            if let constraints = slot.contentConstraints,
               let encoded = try? jsonValue(constraints) {
                children["x-skalman-node-constraints"] = encoded
            }
            return .object([
                "type": .string("object"),
            ...
            "properties": .object([
                ...
                "items": .object([
                    ...
                    "properties": .object([
                        ...
                        "value": .object([
                            "$ref": .string(
                                "https://skalman.invalid/schema/extension-host.schema.json#/$defs/propertyValue"
                            )
                        ])
                    ])
                ])
        ...
        if contract.replacement == .contentOnly {
            ...
            if let constraints = contract.replacementConstraints,
               let encoded = try? jsonValue(constraints) {
                replacement["x-skalman-node-constraints"] = encoded
            }
        ...
        if let constraints = contract.hookConstraints {
            ...
            if let encoded = try? jsonValue(constraints) {
                hook["x-skalman-node-constraints"] = encoded
            }
        ...
        return .object([
            ...
            "$id": .string(
                "https://skalman.invalid/schema/components/\(contract.id.rawValue)-v\(contract.version).schema.json"
            ),
            "title": .string(
                "Skalman \(contract.id.rawValue) v\(contract.version) component patch"
            ),
            "type": .string("object"),
            "additionalProperties": .bool(false),
            "required": .array([
    ...
    public static func documentationMarkdown() -> String {
        var lines = [
            "# Skalman public component catalogue",
            "",
            "<!-- Generated by SkalmanComponentCatalogGenerator. Do not edit by hand. -->",
            "",
