...
///
/// Services exchange JSON values through Skalman's broker. They never expose the provider's
...
/// The successful provider result returned by Skalman's host broker to the consumer.
