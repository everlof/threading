...
@_extern(wasm, module: "skalman", name: "host_exchange")
@_extern(c)
private func skalmanHostExchange(
...
public final class ExtensionHostDescriptorTransport: @unchecked Sendable {
...
#if !os(WASI)
        queue = DispatchQueue(
            label: "se.mjukis.skalman.extension-host-descriptor.\(descriptor)"
        )
#endif
    }
    ...
    static func serialize(
        ...
        head += "Host: skalman-extension-host\r\n"
