...
/// Stable IDs for Skalman's built-in Settings pages.
///
...
/// A semantic settings control rendered by Skalman.
///
/// This is intentionally a compact form vocabulary rather than an AppKit archive. It gives
/// extensions durable values while Skalman retains typography, validation presentation,
...
/// A complete new page contributed to Skalman's Settings sidebar.
...
public enum ExtensionSettingsEnvironment {
    public static let valuesJSON = "SKALMAN_EXTENSION_SETTINGS_JSON"
