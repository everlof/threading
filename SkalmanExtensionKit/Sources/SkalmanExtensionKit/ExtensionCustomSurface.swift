...
/// A custom visual surface described by an extension and hosted by Skalman.
///
/// The extension owns the declarative surface definition. Skalman owns the native view,
...
///
/// `shaderResource` is package-relative source. Skalman supplies the fullscreen vertex stage,
...
public struct ExtensionMetalSurface: Equatable, Sendable {
    public static let defaultFragmentFunction = "skalmanExtensionFragment"
