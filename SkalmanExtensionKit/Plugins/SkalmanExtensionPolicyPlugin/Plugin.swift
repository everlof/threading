...
@main
struct SkalmanExtensionPolicyPlugin: BuildToolPlugin {
    func createBuildCommands(
        ...
        let checker = try context.tool(named: "SkalmanExtensionPolicyChecker")
        let stamp = context.pluginWorkDirectory.appending("extension-policy.stamp")

        return [
            .buildCommand(
                displayName: "Enforce safe Skalman extension boundary",
