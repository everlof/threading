...
Object.assign(process.env, {
  ...
  APNS_TEAM_ID: "test-required-apns-team",
  APNS_KEY_ID: "test-required-apns-key",
  APNS_PRIVATE_KEY: "test-required-apns-private-key",
  PUSH_TOKEN_ENCRYPTION_SECRET: "test-required-push-token-secret-at-least-32-bytes",
  ...
  REPORT_ALERT_WEBHOOK_URL: "https://triage.test/threading/reports",
  REPORT_ALERT_WEBHOOK_TOKEN: "test-required-report-alert-token-at-least-32-bytes",
});
      ...
      return {
        ...
        miniflare: {
          bindings: {
            ...
            PUSH_TOKEN_ENCRYPTION_SECRET: "test-only-push-token-secret-at-least-32-bytes",
            TURN_KEY_ID: "",
            TURN_KEY_API_TOKEN: "",
            REPORT_PICKUP_TOKEN: "test-only-report-pickup-token-at-least-32-bytes",
            REPORT_ALERT_WEBHOOK_URL: "https://triage.test/threading/reports",
            REPORT_ALERT_WEBHOOK_TOKEN: "test-only-report-alert-token-at-least-32-bytes",
