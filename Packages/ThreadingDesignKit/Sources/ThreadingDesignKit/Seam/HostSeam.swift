...
public enum AppThemePalette {
    ...
    public static func install(_ theme: AppTheme) {
    ...
    public static func color(_ role: AppThemeRole) -> NSColor {
...
public struct AppThemeDidChange: AppEvent {
    public static let name = Notification.Name("AppThemeDidChange")
...
public struct AppSettings {
    ...
    public nonisolated(unsafe) static var appTextSize: AppTextSize = .standard
...
public enum ThemeAssetStore {
    public nonisolated(unsafe) static var resolve: (@Sendable (String, AppThemeID) -> NSImage?)?
    public static func image(named assetName: String, for themeID: AppThemeID) -> NSImage? {
...
public final class ThemeManager: @unchecked Sendable {
    ...
    public var allThemes: [TerminalTheme] = TerminalTheme.builtInThemes
}
...
public enum AppThemeLibrary {
    public static var current: AppTheme { AppThemePalette.current }
    public static func theme(withID id: AppThemeID) -> AppTheme? {
        AppThemeStyles.all.first { $0.id == id }
    }
    public static func apply(_ theme: AppTheme) { AppThemePalette.install(theme) }
}
...
public enum PaneHeaderDefaults {
    public static var height: CGFloat { PaneHeaderView.bandHeight }
    public static let inset: CGFloat = Design.Spacing.medium
}
