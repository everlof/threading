...
let manifest = ExtensionManifest(
    identifier: "codes.threading.examples.rain",
    name: "Usage Rain",
    version: "0.1.0",
    runtime: .webAssembly,
...
try ThreadingComponentCatalog.applicationMainWindow.validate(rainHook)
...
case ["--threading-serve"]:
    ...
    // supervised process; EOF means Threading disabled, reloaded, or removed this generation.
