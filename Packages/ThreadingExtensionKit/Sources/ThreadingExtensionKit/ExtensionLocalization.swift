...
public enum ExtensionLocalizationEnvironment {
    public static let localeIdentifier = "THREADING_EXTENSION_LOCALE"
    public static let preferredLanguagesJSON = "THREADING_EXTENSION_PREFERRED_LANGUAGES_JSON"
    public static let selectedLanguage = "THREADING_EXTENSION_LANGUAGE"
    public static let stringsJSON = "THREADING_EXTENSION_LOCALIZED_STRINGS_JSON"
}
