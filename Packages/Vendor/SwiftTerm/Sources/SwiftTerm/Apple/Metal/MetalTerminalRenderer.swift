    ...
    private static func candidateBundles() -> [Bundle] {
        ...
        for container in containerBundles {
            let urls = [
                ...
                // `swift test` places the package resource bundle beside the `.xctest` bundle,
                // not inside it. Keep that shipping-independent layout discoverable too.
                container.bundleURL.deletingLastPathComponent().appendingPathComponent(bundleName)
            ]
