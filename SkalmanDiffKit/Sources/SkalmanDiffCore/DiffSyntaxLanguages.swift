...
public enum DiffSyntaxLanguages {
    ...
    public static let cFamily = curly(
        keywords: """
    ...
    public static let javascript = curly(
        keywords: """
    ...
    public static let kotlin = curly(
        keywords: """
    ...
    public static let python = hashScript(
        keywords: """
    ...
    public static let ruby = hashScript(
        keywords: """
    ...
    public static let shell = hashScript(
        keywords: """
    ...
    public static let yaml = hashScript(keywords: "true false null yes no on off")

    public static let toml = hashScript(keywords: "true false")
    ...
    public static let json = DiffSyntaxLanguage(
        lineComments: [],
        blockComment: nil,
        stringDelimiters: ["\""],
        escapesWithBackslash: true,
    ...
    public static let sql = DiffSyntaxLanguage(
        lineComments: ["--"],
        blockComment: (open: "/*", close: "*/"),
        stringDelimiters: ["'", "\""],
    ...
    public static let css = DiffSyntaxLanguage(
        lineComments: ["//"],
        blockComment: (open: "/*", close: "*/"),
        stringDelimiters: ["\"", "'"],
        escapesWithBackslash: true,
    ...
    public static let byExtension: [String: DiffSyntaxLanguage] = [
        "swift": swift,
    ...
    public static let byFilename: [String: DiffSyntaxLanguage] = [
        "makefile": shell,
        "dockerfile": shell,
        "rakefile": ruby,
        "gemfile": ruby,
