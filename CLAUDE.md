...
| A session's PTY outliving the app: the `threading-ptyd` wire contract, its framing and frames, the version gate, the ring and the exact rejoin | [`pty-host.md`](docs/architecture/pty-host.md) |
