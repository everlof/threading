...
`scripts/publish_local_release.sh`: it names the outer `master` and one annotated tag as explicit
refspecs and disables recursion in both configuration and the push option. Do not generalize its
push primitive into a convenience command.
