...
| External or local events starting bounded agent work: immutable trigger revisions, durable runs, the `threading-triggerd` inbox, two-stage authority, source health and MCP configuration | [`triggers.md`](docs/architecture/triggers.md) |
